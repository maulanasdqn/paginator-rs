...
```toml
[dependencies]
paginator-sea-orm = { version = "0.3.2", features = ["sqlx-postgres", "runtime-tokio"] }
...
```toml
[dependencies]
paginator-surrealdb = { version = "0.3.2", features = ["protocol-ws", "kv-mem"] }
