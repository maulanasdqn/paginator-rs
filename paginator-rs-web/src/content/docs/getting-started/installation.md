...
```toml
[dependencies]
paginator-sqlx = { version = "0.4.0", features = ["mysql", "runtime-tokio"] }
...
```toml
[dependencies]
paginator-sqlx = { version = "0.4.0", features = ["sqlite", "runtime-tokio"] }
...
```toml
[dependencies]
paginator-sea-orm = { version = "0.4.0", features = ["sqlx-postgres", "runtime-tokio"] }
...
```toml
[dependencies]
paginator-surrealdb = { version = "0.4.0", features = ["protocol-ws", "kv-mem"] }
