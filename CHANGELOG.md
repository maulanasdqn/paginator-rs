...
- Version alignment release. All crates, including `paginator-zod`, are republished at
  0.3.2 in lockstep, and every crate's crates.io README now includes the zod-rs
  integration docs. No API changes.
